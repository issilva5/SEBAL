landsat<-function(){
  ...
  #print("Radiação de onda curta incidente")
  ...
  #print("Temperatura de Superfície em Kelvin (TS)")
  ...
  #print("Radiação de onda longa emitida pela superfície (RLsup)")
  RLsup_temp<-Eo_temp*5.67*10^-8*TS_temp^4
  
  #print("Emissividade atmosférica (Ea)")
  Ea_temp<-0.85*(-1*log(tal[]))^0.09 # Céu Claro
  
  #print("Radiação de onda longa emitida pela atmosfera (RLatm)")
  RLatm_temp<-Ea_temp*5.67*10^-8*(table.sw$V7[2]+273.15)^4
  
  #print("Saldo de radiação Instantânea (Rn)")
